...
clean_2019 <- qpcr_2019 %>% 
  clean_names() %>% 
  select(!c(well, well_position, site, region_code, site_code, species, ipc, bd_pos_neg, extraction_tech, extraction_lab, q_pcr_tech,
            q_pcr_lab))
...
panama_qpcr <- plyr::rbind.fill(clean_2014, clean_2015, clean_2016, clean_atelopus, clean_fall_2012, clean_winter_2013, clean_summer_2013, js_samps) %>% 
