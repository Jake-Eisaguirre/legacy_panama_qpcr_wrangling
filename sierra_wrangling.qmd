...
quant_cycle <- plyr::rbind.fill(results, results_ucsb) %>% 
  select(sample_id, quant_cycle, plate_id) %>% 
...
# 
# (replicate = case_when(replicate == 1 ~ "singley",
...
# ,
#          result = case_when(replicate == "singley" ~ result,
#                             replicate == "duplicate" ~ paste(result, result, sep = ","),
#                             replicate == "triplicate" ~ paste(result, result, result, sep = ","),
#                             replicate == "quadruplicate" ~ paste(result, result, result, result, sep = ","),
#                             replicate == "quintuple" ~ paste(result, result, result, result, result, sep = ","))
